...
public class QASpaceReporter implements Reporter, Formatter {
    ...
    public void startOfScenarioLifeCycle(Scenario scenario) {
        if (isJIRATestKeyPresent(scenario)) {
            listenedTest = true;
            TestResultProcessor.startJiraAnnotatedTest(getJIRAKey(scenario));
        }
    }
    ...
    private String getJIRAKey(Scenario scenario) {
    ...
    private boolean isJIRATestKeyPresent(Scenario scenario) {
